...
use BabyFootBundle\Validator\Constraints as BBFAssert;
...
class Team
{
     ...
     * @Assert\NotBlank()
     * @Assert\Count( min="2", max="2", exactMessage="Je veux mon message!")
     */
    private $players;

    /**
     * @ORM\ManyToMany(targetEntity="Tournament")
     */
    private $tournaments;
     ...
     * Add player
     *
     * @param \BabyFootBundle\Entity\Player $player
     *
     * @return Team
     */
    public function addPlayer(\BabyFootBundle\Entity\Player $player)
    {
        $this->players[] = $player;
     ...
     * @param \BabyFootBundle\Entity\Player $player
     */
    public function removePlayer(\BabyFootBundle\Entity\Player $player)
    {
